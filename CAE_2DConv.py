...
class Autoencoders_lightning(pl.LightningModule):
    def __init__(self,**dict_args):
        ...
        ##encoder layers
        self.conv_block_1 = BasicConv(1,128,(1,3,3), stride=1, padding=(0,1,1), bn = True, relu=True)
        self.conv_block_2 = BasicConv(128,64,(1,3,3), stride=1, padding=(0,1,1), bn = True, relu = True)
        self.conv_block_3 = BasicConv(64,32,(1,3,3), stride=1, padding=(0,1,1), bn=True, relu=True)
        self.max_pool_1 = nn.MaxPool3d((1,2,2))
        self.max_pool_2 = nn.MaxPool3d((1,2,2))

        ##decoder layers
        self.dec_convtrans_1 = nn.ConvTranspose3d(32,64,(1,3,3),stride=1, padding=(0,1,1))
        self.dec_convtrans_2 = nn.ConvTranspose3d(64,128,(1,3,3),stride=(1,2,2), padding=(0,1,1), output_padding=(0,1,1))
        self.dec_convtrans_3 = nn.ConvTranspose3d(128,1,(1,3,3),stride=(1,2,2), padding=(0,1,1), output_padding=(0,1,1))
...
def main(args):
    ...
    if settng=='train':
        ...
        model = Autoencoders_lightning.load_from_checkpoint(checkpoint_path='lightning_logs/version_1/checkpoints/epoch=2.ckpt')
        trainer.test(model)
